...
$(document).ready(function() {
    var t=  $('.server-side').DataTable( {
        ...
        "columns": [
            ...
            {"render": function ( data, type, row ) {
                return '<a type="button" href=/admin/tamano/edit/'+row._id+' class="btn btn-primary"><i class="feather icon-edit-2"></i></a>'
    ...
    if (modal == true) {
        $.get("http://localhost:3000/admin/tamano/borrarFragancias/"+id, function( data ) {
