// var numIng = null;
// var numTotal = null;
// var numeroTotal = null;
// var numPorcentaje = null;
$(document).ready(function () {



    let input = $('#numeroIngresado');
    let input2 = $('#numCalcular');
    ...
    function porcentaje() {
        var numIng = parseInt($('#numeroIngresado').val());
        var numPorcentaje = parseInt($('#numCalcular').val());

        var numTotal = (numIng * numPorcentaje) / 100 + numIng;

        $('#numeroTotal').val(parseInt(numTotal));
